    ...
    <div class="p-5">
        ...
        <div class="grid grid-cols-2 gap-3 mb-5">
            ...
            <div class="flex items-center">
                ...
                <span class="text-sm text-gray-600">{{ $job->experience }}</span>
            </div>
            ...
            <div class="flex items-center">
                ...
                <span class="text-sm text-gray-600">{{ $job->category }}</span>
            </div>
        </div>
        ...
        <div class="flex gap-3 mt-4">
            @if(request()->route()->getName() === 'jobs.index' || request()->path() === '/')
                ...
                <a href="{{ route('jobs.show', $job->id) }}" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded text-center transition-colors duration-200">
                    View Details
                </a>
            @else
                <!-- On job detail page, show Back to Home button -->
                <a href="{{ route('jobs.index') }}" class="flex-1 bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded text-center transition-colors duration-200">
                    Back to Jobs
                </a>
